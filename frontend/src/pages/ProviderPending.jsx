...
// ✅ COMPLETE FIXED - Prevent infinite loops with useRef and proper dependencies
...
const ProviderPending = () => {
  ...
  useEffect(() => {
    ...
    if (!hasRedirectedRef.current && user?.role === "provider") {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-10 bg-gradient-to-br from-[#0D9488]/5 via-white to-[#F59E0B]/5 dark:from-gray-950 dark:via-gray-900 dark:to-black">
      ...
      >
        ...
        {/* STATUS ICON - Updated with AI Tour colors */}
        <motion.div
        ...
        {/* STATUS CARD - Updated with AI Tour colors */}
        ...
        {/* FEATURES - Updated with AI Tour colors */}
        ...
        {/* BUTTONS - Updated with AI Tour colors */}
